...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ContactSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC10ContactSDK13ContactBridge")
@interface ContactBridge : CrossBase
@end


SWIFT_CLASS("_TtC10ContactSDK7Contact")
@interface Contact : ContactBridge
@end



SWIFT_CLASS("_TtC10ContactSDK19ContactDataListener")
@interface ContactDataListener : CrossBase
- (void)onNotify:(NSString * _Nonnull)humanCode :(NSInteger)channelType :(NSString * _Nonnull)dataId :(NSInteger)status;
- (NSData * _Nullable)onReadData:(NSString * _Nonnull)humanCode :(NSInteger)channelType :(NSString * _Nonnull)dataId :(int64_t)offset SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)onWriteData:(NSString * _Nonnull)humanCode :(NSInteger)channelType :(NSString * _Nonnull)dataId :(int64_t)offset :(NSData * _Nullable)data SWIFT_WARN_UNUSED_RESULT;
@end
